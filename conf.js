...
/*
There are 3 ways to customize conf in modules that use btmcore lib:
...
var conf = require('btmcore/conf.js');
...
if (exports.storage === 'mysql'){
	...
	exports.database.name = exports.database.name || 'btm';
	exports.database.user = exports.database.user || 'btm';
}
else if (exports.storage === 'sqlite'){
	exports.database.max_connections = exports.database.max_connections || 1;
	exports.database.filename = exports.database.filename || (exports.bLight ? 'btm-light.sqlite' : 'btm.sqlite');
}
